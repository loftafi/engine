...
test "normal_use" {
    ...
    try expectEqual(display.text_height.pixel_height(1), button.rect.height / display.pixel_density);
    try expectEqual(display.text_height.pixel_height(2) + 4 + 5, panel.rect.height);
